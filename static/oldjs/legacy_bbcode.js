...
function bbEncode(S) {
    ...
    S = S.replace("MysticDragonfly", "MysticAnusfly");
    ...
    function P($0, $1, $2, $3) {
        ...
        while (linkint.toLowerCase().substr(0,7) == "onerror") { linkint = linkint.substring(7); }
        linkint = linkint.replace(/["'{}]/g, "");
        linkint = linkint.replace(/^\s*javascript/ig, "XSS");
        $2 = linkint;
        switch ($1) {
